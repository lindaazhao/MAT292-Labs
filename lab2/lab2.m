...
title("Solution to the IVP");
legend('Exact', 'Interpolated Between t = 2 and t = 3','Location','southeast');
xlabel('t');
ylabel('y');
% =========================================================================================
...
title("Error of Numerical Solution (Linear-Log Plot)");
xlabel('t');
ylabel('error');
% =========================================================================================
...
title("Numerical Approximation of Solution to the IVP");
xlabel('t')
ylabel('y')
